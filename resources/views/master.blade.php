...
<head>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" type="text/javascript" charset="utf-8" async defer></script>
...
<body>
		<nav>
			<ul class = "grid items-center xl:h-24 xl:grid-cols-2 font-medium text-xl">
				...
				<div class="options flex items-center flex-wrap w-9/12 justify-center ml-auto">
					@yield("nav-options")
                    @guest
                        <li class="nav-item">
